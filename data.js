            ...
            subsections: [
              {
                ...
                paragraphs: [
                  "针对不同生命周期及不同经营场景的客户，在移动端建设完整的任务中心，通过差异化任务承接客户成长："
                ],
                groups: [
                  {
                    title: "新手任务｜提升新客激活与留存",
                    paragraphs: [
                      "面向首次进入乘风的新客户，将广告投放关键动作转化为明确、低门槛的成长任务，通过目标牵引帮助客户快速理解平台、完成正确投放，缩短新客学习路径。"
                    ]
                  },
                  {
                    title: "成长任务｜促进客户持续投放",
                    paragraphs: [
                      "面向已经完成首次投放、处于成长阶段的客户，通过阶段性任务持续引导客户增加平台使用深度，促进新客向稳定投放客户转化。"
                    ]
                  },
                  {
                    title: "激励任务｜放大关键经营节点投入",
                    paragraphs: [
                      "结合双 11、618 等大促及重点营销场景，通过阶段性激励任务提升客户投放积极性，撬动关键节点广告预算投入。"
                    ]
                  },
                  {
                    title: "流程图",
                    ...
                    conclusion: "<strong>核心价值：</strong>将原本依赖客户自主探索的投放过程，转变为平台主动引导的成长路径，让“任务”成为连接客户行为与业务增长的长期运营抓手。"
                  }
                ]
              },
              {
