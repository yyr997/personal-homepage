          ...
          },
          {
            ...
            subsections: [
              ...
              },
              {
                ...
                paragraphs: [
                  "任务发布并不意味着客户一定能够感知和完成。",
                  "为了进一步提高任务完成率，在任务生命周期的关键节点建立自动化触达机制，根据 <strong>任务领取、任务进行、任务截止、任务完成、奖励领取</strong> 等不同状态，通过平台内消息、短信等渠道主动触达客户。",
                  "如下为 2025 年 4—6 月的新手任务领取情况："
                ],
                imageAfter: {
                ...
                groups: [
                  {
                    title: "重点解决三个问题",
                    paragraphs: [
                      "<strong>客户不知道有任务 → 客户知道但容易忘记 → 完成任务后未感知到领取了奖励</strong>",
                      "通过关键节点的主动提醒，提高任务曝光度与紧迫感，推动用户从“看到任务”进一步转化为“执行任务、完成任务、领取奖励”。"
                    ],
                    conclusion: "<strong>核心价值：</strong>从单纯建设“任务功能”，进一步形成 <strong>任务配置—用户触达—任务执行—奖励转化</strong> 的完整营销闭环，提升任务体系本身的运营效率和规模化能力。"
                  }
                ]
              },
              {
